...
class FeignCircuitBreakerTargeter implements Targeter {
    ...
    private <T> T getFromContext(String fallbackMechanism,
        ...
        if (fallbackInstance == null) {
            throw new IllegalStateException(
                    String.format("No " + fallbackMechanism + " instance of type %s found for feign client %s", beanType, feignClientName));
        }
